...
![Latest version](https://img.shields.io/badge/latest-1.3.2-green)
...
| \>=[3.16.3](https://github.com/algolia/algoliasearch-magento-2/releases/tag/3.16.3), \>=[3.17.3](https://github.com/algolia/algoliasearch-magento-2/releases/tag/3.17.3)               | ~1.3.2                     |
...
```
composer require \
    algolia/algoliasearch-magento-2:~3.17.3 \
